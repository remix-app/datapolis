        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-sm border-l-4 border-accent2">
                        <div class="flex justify-between items-start mb-2">
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-sm border-l-4 border-gray-200">
            ...
            <div class="relative">
                <img src="images/servicio-1.webp" alt="Automatización Inteligente" class="rounded-2xl shadow-2xl">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <div class="order-2 lg:order-1 relative">
                <img src="images/servicio-2.webp" alt="Analytics & Data Science" class="rounded-2xl shadow-2xl">
            ...
            <div class="order-1 lg:order-2">
                ...
                <!-- Service Items -->
                <div class="space-y-6">
                    <div class="bg-secondary/50 p-6 rounded-xl border border-white/10">
                        <div class="flex justify-between items-start mb-2">
...
<section id="chatbots" class="py-24 bg-light text-primary">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="relative">
                <img src="images/servicio-3.webp" alt="Chatbots & Asistentes IA" class="rounded-2xl shadow-2xl">
...
<section id="vision" class="py-24 bg-primary">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <div class="order-2 lg:order-1 relative">
                <img src="images/servicio-4.webp" alt="Visión Computacional" class="rounded-2xl shadow-2xl">
            </div>
...
<section id="consultoria" class="py-24 bg-gradient-to-br from-secondary to-primary">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="bg-accent/10 backdrop-blur-sm p-8 rounded-2xl border border-accent text-center relative">
                <span
            ...
            <div
                ...
                <div class="w-16 h-16 rounded-full bg-accent2/20 flex items-center justify-center mx-auto mb-6">
                    <i class="fas fa-users-cog text-accent2 text-2xl"></i>
                </div>
...
<section id="capacitacion" class="py-24 bg-light text-primary">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="space-y-6">
                    <div class="bg-white p-6 rounded-xl shadow-sm border-l-4 border-accent">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-xs text-gray-400"><i class="far fa-clock mr-1"></i> 4 horas</span>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-sm border-l-4 border-accent2">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-xs text-gray-400"><i class="far fa-clock mr-1"></i> 24 horas (6
                                semanas)</span>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-sm border-l-4 border-gray-200">
                        ...
                        <p class="text-gray-500 text-sm mb-2">Formación personalizada para tu equipo en tus
                            instalaciones</p>
                        <div class="flex justify-between items-center">
                            <span class="text-xs text-gray-400"><i class="fas fa-users mr-1"></i> Grupos de 5-15
                                personas</span>
            ...
            <div class="relative">
                <img src="images/servicio-6.webp" alt="Capacitación en IA" class="rounded-2xl shadow-2xl">
                <div class="absolute -bottom-6 -left-6 bg-primary text-white p-6 rounded-xl shadow-xl">
