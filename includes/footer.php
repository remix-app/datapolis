    ...
    <footer class="bg-primary border-t border-white/5 relative">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                ...
                <div class="lg:col-span-1">
                    <a href="index.php" class="flex items-center space-x-2 mb-6">
                        <img src="images/logo.webp" alt="Logo Datpolis IA" class="logo-footer">
                    </a>
                    <p class="text-muted text-sm leading-relaxed mb-6">
                        Impulsamos el crecimiento de PyMEs en Chile con soluciones de Inteligencia Artificial accesibles y efectivas.
                    </p>
                    <!-- Social Icons -->
                    <div class="flex space-x-4">
                        <a href="#" class="w-10 h-10 rounded-full bg-secondary/50 flex items-center justify-center text-muted hover:text-accent hover:bg-secondary transition-all">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li>
                            <a href="#" class="text-muted hover:text-accent transition-colors text-sm">
                                Inicio
                            </a>
                        </li>
                        <li>
                            <a href="#servicios" class="text-muted hover:text-accent transition-colors text-sm">
                                Servicios
                            </a>
                        </li>
                        <li>
                ...
                <div>
                    ...
                    <ul class="space-y-4 text-sm">
                       ...
                       <!-- <li class="flex items-center space-x-3">
                            ...
                            <a href="tel:+56912345678" class="text-muted hover:text-accent transition-colors">
                                +56 9 1234 5678
                            </a>
                        </li> -->
                        <li class="flex items-center space-x-3">
                            <i class="fab fa-square-whatsapp text-accent"></i>
                            <a href="https://wa.me/56912345678" class="text-muted hover:text-accent transition-colors">
                                WhatsApp
                            </a>
                        </li>
                        <li class="flex items-center space-x-3">
                        ...
                        <li class="flex items-center space-x-3">
                            ...
                            <a href="#" class="text-muted hover:text-accent transition-colors">
                                Términos de uso
                            </a>
                        </li>
                    </ul>
            ...
            <div class="h-0.5 gradient-border">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                <div class="flex flex-col md:flex-row items-center justify-between text-sm text-muted">
                    ...
                    <div class="flex space-x-6 mt-4 md:mt-0">
                        <a href="https://cuboid-ia.com" class="hover:text-accent transition-colors">Diseñado con <span style="color:#7c3aed">&#9829;</span> por <strong>Cuboid IA</strong></a>
                    </div>
                </div>
            </div>
        </div>
