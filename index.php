...
<section class="relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div class="absolute inset-0">
        <img src="images/hero.webp" alt="Datapolis - IA para PyMEs" class="w-full h-full object-cover">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
        ...
        <p class="text-accent uppercase tracking-[0.3em] text-sm font-medium mb-6 float-animation">
            <i class="fas fa-map-marker-alt mr-2"></i> Santiago y Todo Chile
        </p>
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="relative">
                <div class="aspect-square rounded-2xl overflow-hidden shadow-2xl">
                    <img src="images/ambiente.webp" alt="Equipo Datapolis trabajando" class="w-full h-full object-cover">
                </div>
                <!-- Floating Card -->
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-2 gap-8">
            ...
            <div
                ...
                <div class="aspect-square overflow-hidden" id="servicios">
                    <img src="images/servicio-1.webp" alt="Protección de datos al trabajar con ChatGPT"
                        class="card-image w-full h-full object-cover transition-transform duration-500">
                </div>
                <div class="p-6 border-l-4 border-accent">
                    <span class="text-xs uppercase tracking-wider text-accent font-semibold">Curso introductorio (IA 101)</span>
                    <h3 class="font-heading text-2xl font-bold mt-2 mb-3">Protección de datos<br>al trabajar con ChatGPT</h3>
            ...
            <div
                ...
                <div class="aspect-square overflow-hidden">
                    <img src="images/servicio-2.webp" alt="Habilitar Excel para el trabajo con ChatGPT"
                        class="card-image w-full h-full object-cover transition-transform duration-500">
                </div>
                <div class="p-6 border-l-4 border-accent">
                    <span class="text-xs uppercase tracking-wider text-accent font-semibold">Curso introductorio (IA 101)</span>
                    <h3 class="font-heading text-2xl font-bold mt-2 mb-3">Habilitar Excel para<br>el trabajo con ChatGPT</h3>
                    <p class="text-muted text-sm">
            ...
            <div
                class="group card-hover bg-secondary/30 rounded-2xl overflow-hidden border border-white/5 hover:border-accent/50">
                <div class="aspect-square overflow-hidden">
                    <img src="images/servicio-3.webp" alt="ChatGPT aplicado: Declaraciones Juradas"
                        class="card-image w-full h-full object-cover transition-transform duration-500">
                </div>
                <div class="p-6 border-l-4 border-accent2">
                    <span class="text-xs uppercase tracking-wider text-accent2 font-semibold">Curso intermedio (IA 201)</span>
                    <h3 class="font-heading text-2xl font-bold mt-2 mb-3">ChatGPT aplicado:<br>Declaraciones Juradas</h3>
                    <p class="text-muted text-sm">
            ...
            <div
                class="group card-hover bg-secondary/30 rounded-2xl overflow-hidden border border-white/5 hover:border-accent/50">
                <div class="aspect-square overflow-hidden">
                    <img src="images/servicio-4.webp" alt="Contabilidad potenciada con IA"
                        class="card-image w-full h-full object-cover transition-transform duration-500">
                </div>
                <div class="p-6 border-l-4 border-accent2">
                    <span class="text-xs uppercase tracking-wider text-accent2 font-semibold">Curso intermedio (IA 201)</span>
                    <h3 class="font-heading text-2xl font-bold mt-2 mb-3">Contabilidad potenciada con<br>Inteligencia Artificial</h3>
                    <p class="text-muted text-sm">
            ...
            <div
                class="group card-hover bg-secondary/30 rounded-2xl overflow-hidden border border-white/5 hover:border-accent/50">
                <div class="aspect-square overflow-hidden">
                    <img src="images/servicio-5.webp" alt="ChatGPT aplicado: Creando informes IA"
                        class="card-image w-full h-full object-cover transition-transform duration-500">
                </div>
                <div class="p-6 border-l-4 border-accent">
                    <span class="text-xs uppercase tracking-wider text-accent font-semibold">Curso Avanzado (IA 301)</span>
            ...
            <div
                class="group card-hover bg-secondary/30 rounded-2xl overflow-hidden border border-white/5 hover:border-accent/50">
                <div class="aspect-square overflow-hidden">
                    <img src="images/servicio-6.webp" alt="Ley 21.713: El Asesor Estratégico"
                        class="card-image w-full h-full object-cover transition-transform duration-500">
                </div>
                <div class="p-6 border-l-4 border-accent">
                    <span class="text-xs uppercase tracking-wider text-accent font-semibold">Curso Avanzado (IA 301)</span>
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center" id="contacto">
            ...
            <div class="relative order-2 lg:order-1">
                <div class="aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl">
                    <img src="images/ambiente2.webp" alt="Equipo Datapolis" class="w-full h-full object-cover">
                </div>
                <!-- Stats Card -->
            ...
            <div class="order-1 lg:order-2">
                ...
                <p class="text-lg text-gray-600 mb-6 leading-relaxed">
                    Datapolis transforma profesionales y PyMEs mediante capacitación práctica en IA, con foco en resultados medibles, casos reales del mercado chileno y un enfoque ético que pone la tecnología al servicio de negocios sostenibles</p>
                <p class="text-lg text-gray-600 mb-8 leading-relaxed">
                    Hoy somos un equipo de profesionales apasionados por hacer que la tecnología trabaje para todos. Cada proyecto
...
<section class="relative py-32 overflow-hidden">
    <!-- Background -->
    <div class="absolute inset-0">
        <img src="images/hero.webp" alt="Datapolis CTA" class="w-full h-full object-cover">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
                ...
                <p class="text-lg text-gray-600 mb-6 leading-relaxed">
                    La Inteligencia Artificial está revolucionando la forma en que las PyMEs chilenas compiten en el mercado actual. En Datapolis, ofrecemos cursos especializados diseñados para contadores, administradores y emprendedores que buscan automatizar procesos, optimizar la toma de decisiones y potenciar la productividad de sus negocios.
                </p>
                <p class="text-lg text-gray-600 mb-8 leading-relaxed">
                    Nuestros programas de verano 2026 combinan teoría y práctica, enfocándose en herramientas reales como ChatGPT, Excel con IA y soluciones específicas para el sector contable chileno. Desde la protección de datos hasta la creación de informes automatizados, cada curso está diseñado para generar resultados inmediatos en tu actividad profesional.
                </p>
            ...
            <div class="relative">
                <div class="aspect-square rounded-2xl overflow-hidden shadow-2xl">
                    <img src="images/ambiente3.webp" alt="Equipo Datapolis trabajando" class="w-full h-full object-cover">
                </div>
            </div>
        </div>
    </div>
